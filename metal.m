...
IgusaClebschInvariants[poly_, x_Symbol] /; PolynomialQ[poly, x] && Exponent[poly, x] <= 6 := 
   Module[{v}, v = PadRight[CoefficientList[poly, x], 7]; {IgusaClebschInvariantsI2 . v . v, IgusaClebschInvariantsI4 . v . v . v . v, 
      IgusaClebschInvariantsI6 . v . v . v . v . v . v, IgusaClebschInvariantsI10 . v . v . v . v . v . v . v . v . v . v}]; 
